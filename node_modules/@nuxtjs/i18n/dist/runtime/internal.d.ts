...
export declare function getLocaleCookie(cookieRef: CookieRef<string | undefined>): string | undefined;
export declare function setLocaleCookie(cookieRef: CookieRef<string | undefined>, locale: string): void;
